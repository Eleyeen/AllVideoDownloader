...
public class LMvdActivity extends Activity implements TextView.OnEditorActionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoSites.setAdapter(new marabillas.loremar.lmvideodownloader.VideoStreamingSitesList(this));
    ...
    public void onBackPressed() {
        ...
        } else if (marabillas.loremar.lmvideodownloader.LMvdApp.getInstance().getOnBackPressedListener() != null) {
            marabillas.loremar.lmvideodownloader.LMvdApp.getInstance().getOnBackPressedListener().onBackpressed();
    ...
    public void setOnBackPressedListener(OnBackPressedListener onBackPressedListener) {
        marabillas.loremar.lmvideodownloader.LMvdApp.getInstance().setOnBackPressedListener(onBackPressedListener);
    }
